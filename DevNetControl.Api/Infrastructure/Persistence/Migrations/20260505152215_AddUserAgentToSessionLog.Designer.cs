...
namespace DevNetControl.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260505152215_AddUserAgentToSessionLog")]
    partial class AddUserAgentToSessionLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevNetControl.Api.Domain.ActivityLog", b =>
                {
                    ...
                    b.Property<int>("CreditsBalanceAfter")
                        .HasColumnType("INTEGER");

                    b.Property<int>("CreditsBalanceBefore")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DevNetControl.Api.Domain.CreditTransaction", b =>
                {
                    ...
                    b.Property<int?>("SourceBalanceAfter")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("SourceBalanceBefore")
                        .HasColumnType("INTEGER");

                    b.Property<Guid?>("SourceUserId")
                        .HasColumnType("TEXT");

                    b.Property<int?>("TargetBalanceAfter")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("TargetBalanceBefore")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DevNetControl.Api.Domain.Tenant", b =>
                {
                    ...
                    b.Property<int>("CreditsPerDevice")
                        .HasColumnType("INTEGER");
